...
void main() {
  ...
  group('ExamTarget & Spaced Repetition Logic Tests', () {
    ...
    test('SpacedRepetitionLevel Leitner box progression and reset', () {
      ...
      expect(SpacedRepetitionLevel.box1.next, equals(SpacedRepetitionLevel.box2));
      expect(SpacedRepetitionLevel.box2.next, equals(SpacedRepetitionLevel.box3));
      expect(SpacedRepetitionLevel.box3.next, equals(SpacedRepetitionLevel.box4));
      expect(SpacedRepetitionLevel.box4.next, equals(SpacedRepetitionLevel.box5));
      expect(SpacedRepetitionLevel.box5.next, equals(SpacedRepetitionLevel.box5));

      expect(SpacedRepetitionLevel.box4.reset, equals(SpacedRepetitionLevel.box1));
    ...
    test('Prompts.examCrunchSchedule string formatting and personality injection', () {
